        ...
        <div class="col-lg-7 mx-auto">
            <div class="card shadow-lg mt-2 mx-auto p-4 bg-light">
                <div class="card-body bg-light">
                    ...
                    <div class="container">
                        <form method="POST" action="{{ route('sector.store') }}" id="contact-form"
                            ...
                            <div class="controls">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-3">
                                        <div class="form-group">
                                            <label for="form_name"class="mb-2">Image (Optional) *</label>
                                            <input id="form_name" type="file" name="image" class="form-control"
                                                placeholder="Please enter your image *" data-error="Image is required.">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-4">
                                        ...
                                        <input type="submit" class="btn btn-success btn-send pt-2 btn-block "
                                            style="margin-left: 9%" value="Add Sector">
                                    </div>
                                </div>
                            </div>
